...
\test{06}{Import feature}{Req-00, Req-01, Req-04}{
    ...
    \item Navigate to the assets folder and select the \texttt{fireflies.lsys} file.
...
\test{08}{Export feature}{Req-04}{
    ...
    \item Save the file to the assets location with the name \texttt{fireflies2.lsys}.
...
\test{09}{Consistency}{Req-00, Req-01, Req-04}{
    \item Press the \texttt{Import} button at the top of the \gls{GUI}.
    \item Navigate to the assets folder and select the \texttt{fireflies2.lsys} file.
    \item Press \texttt{Open}.
}{%
...
\test{10}{Animation start}{Req-01, Req-03, Req-04}{
    \item Press the \texttt{Import} button at the top of the \gls{GUI}.
    \item Navigate to the assets folder and select the \texttt{algae.lsys} file.
    \item Press \texttt{Open}.
...
\test{15}{Syntax errors 1}{Req-01, Req-06}{
    ...
    \item Navigate to the assets folder and select the \texttt{storm.lsys} file.
    \item Press \texttt{Open}.
